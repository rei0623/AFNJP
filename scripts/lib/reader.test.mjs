...
test("editorial company category takes priority over secondary sources",()=>{assert.equal(enrich({category:"Google",title:"Gemini",source_urls:["https://openai.com/a","https://blog.google/a"]}).company,"Google");});
